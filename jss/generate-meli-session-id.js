...
const MERCADOPAGO_MONITOR_URL = 'https://api.mercadopago.com/ppcore/prod/monitor'
...
const LOAD_SCRIPT_METRIC_NAME = IS_DEV ? 'load_embed_block_test' : 'load_embed_block'
...
function createScriptTag() {
  ...
  script.onerror = () => registerDatadogEvent(
...
(() => {
  try {
    ...
    registerDatadogEvent(LOAD_SCRIPT_METRIC_NAME, INSERT_SCRIPT_ERROR, e?.message || e?.toString())
  }
})()
